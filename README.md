...
_ Check if there are existing serives or features that should be used in stead
_ Documentation
_ Create Tests
_ Add to GitHub as additional Module
_ Review and Enhance based on user Feedback
_ Add to Core

It’d be greate if some one can give me some feedback so i can implement and test it. 
## Maintainers

Current maintainers:
- [Farm Mexx](https://github.com/me-xx)
